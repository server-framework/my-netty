...
import com.mjump.game.ws.param.AbstractPKRejectParam;
import com.mjump.game.ws.param.RevMsg;
import com.mjump.game.ws.processor.impl.ParamClazzFactory;
import com.mjump.game.ws.util.JsonUtil;
import com.mjump.game.ws.util.Result;
import com.mjump.game.ws.util.ResultCode;
import com.mjump.game.ws.util.ResultUtil;
...
public class GameRevProcessorDispatch {
    ...
    @Qualifier("RedProcessImpl")
    @Autowired
    private GameRevProcessor redProcessImpl;
